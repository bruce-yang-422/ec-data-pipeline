...
c1105_momo_accounting_orders_schema = [
    ...
    bigquery.SchemaField("order_sn_main", "STRING"),
...
etmall_orders_schema = [
    ...
    bigquery.SchemaField("order_time_1", "STRING"),
    bigquery.SchemaField("order_sn", "STRING"),
    bigquery.SchemaField("item_no", "FLOAT"),
    ...
    bigquery.SchemaField("shipping_confirm_date", "DATE"),
    bigquery.SchemaField("product_sale_id", "FLOAT"),
    bigquery.SchemaField("sub_sale_id", "STRING"),
    bigquery.SchemaField("product_id", "FLOAT"),
    bigquery.SchemaField("sub_product_id", "STRING"),
    bigquery.SchemaField("product_name_platform", "STRING"),
    bigquery.SchemaField("color", "STRING"),
    bigquery.SchemaField("style", "STRING"),
    bigquery.SchemaField("product_attribute", "STRING"),
    ...
    bigquery.SchemaField("customer_phone", "FLOAT"),
    ...
    bigquery.SchemaField("expected_stockin_date", "STRING"),
    bigquery.SchemaField("expected_delivery_date", "STRING"),
    ...
    bigquery.SchemaField("order_date_original", "STRING"),
    bigquery.SchemaField("shipping_confirm_date_original", "STRING"),
    bigquery.SchemaField("shipping_confirm_time", "STRING"),
    bigquery.SchemaField("delivery_company", "STRING"),
    bigquery.SchemaField("product_sale_id_shipping", "STRING"),
    bigquery.SchemaField("product_name_platform_shipping", "STRING"),
    bigquery.SchemaField("color_shipping", "STRING"),
    bigquery.SchemaField("style_shipping", "STRING"),
    bigquery.SchemaField("seller_product_sn_shipping", "STRING"),
    bigquery.SchemaField("quantity_shipping", "STRING"),
    bigquery.SchemaField("unit_price_shipping", "STRING"),
    bigquery.SchemaField("cost_to_platform_shipping", "STRING"),
    bigquery.SchemaField("customer_name_shipping", "STRING"),
    bigquery.SchemaField("customer_phone_shipping", "STRING"),
    bigquery.SchemaField("shipping_address_shipping", "STRING"),
    bigquery.SchemaField("note_shipping", "STRING"),
    bigquery.SchemaField("shipping_instruction_date", "STRING"),
    bigquery.SchemaField("shipping_instruction_time", "STRING"),
]
